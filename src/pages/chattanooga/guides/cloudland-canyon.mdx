---
title: "Cloudland Canyon State Park: Hikes, Waterfalls & Caves"
...
<div>
  ...
  <div class="pb-2 text-xl pt-6">
    ...
    <div class="mb-12 mt-12 flex flex-col md:flex-row gap-6 items-start">
      ...
      <div class="w-full md:w-2/5 flex flex-col gap-3 pt-2">
        <div><span class="font-semibold">Distance from Chattanooga:</span> ~35 miles south</div>
        <div><span class="font-semibold">Entry fee:</span> $5 daily parking</div>
        <div><span class="font-semibold">Trails:</span> 60+ miles, easy to advanced</div>
        <div><span class="font-semibold">Best for:</span> Hiking, MTB, camping, waterfalls</div>
      </div>
    </div>
    ...
    <section class="text-xl pb-12">
      ...
      <div class="space-y-2">
        <div class="flex gap-3 items-baseline"><span class="text-logoDarkGreen font-bold">1.</span><a href="#easier-hikes" class="gradient-text font-semibold">Easier Hikes</a><span class="text-gray-500 text-base">— Overlook, Meadowlands, Backcountry Loop</span></div>
        <div class="flex gap-3 items-baseline"><span class="text-logoDarkGreen font-bold">2.</span><a href="#mtb-easy" class="gradient-text font-semibold">Easier MTB</a><span class="text-gray-500 text-base">— Bankhead loop, CCC out and back</span></div>
        <div class="flex gap-3 items-baseline"><span class="text-logoDarkGreen font-bold">3.</span><a href="#advanced-hikes" class="gradient-text font-semibold">Advanced Hikes</a><span class="text-gray-500 text-base">— West Rim Loop, Waterfalls Trail, Sitton's Gulch</span></div>
        <div class="flex gap-3 items-baseline"><span class="text-logoDarkGreen font-bold">4.</span><a href="#mtb-advanced" class="gradient-text font-semibold">Advanced MTB</a><span class="text-gray-500 text-base">— Tailings Run, Kettle Bottom</span></div>
        <div class="flex gap-3 items-baseline"><span class="text-logoDarkGreen font-bold">5.</span><a href="#disc-golf" class="gradient-text font-semibold">Disc Golf</a><span class="text-gray-500 text-base">— 18-hole course, no extra fee</span></div>
        <div class="flex gap-3 items-baseline"><span class="text-logoDarkGreen font-bold">6.</span><a href="#camping" class="gradient-text font-semibold">Camping</a><span class="text-gray-500 text-base">— yurts, cabins, RV sites, primitive</span></div>
        <div class="flex gap-3 items-baseline"><span class="text-logoDarkGreen font-bold">7.</span><a href="#fishing" class="gradient-text font-semibold">Fishing</a><span class="text-gray-500 text-base">— stocked pond, no license needed</span></div>
        <div class="flex gap-3 items-baseline"><span class="text-logoDarkGreen font-bold">8.</span><a href="#eating" class="gradient-text font-semibold">Eating Nearby</a><span class="text-gray-500 text-base">— Hope House Cafe, Canyon Grill, Thatcher's BBQ</span></div>
      </div>
    </section>
    ...
    <div class="mt-12 mb-6 md:float-right md:w-2/5 md:ml-6">
    ...
    <div class="mt-12 mb-6 md:float-right md:w-2/5 md:ml-6">
      ...
      <p class="text-xs text-gray-400 mt-1">Photo by formatc1. CC 2.0</p>
    </div> 
    ...
    <div class="mt-12 mb-6 md:float-right md:w-2/5 md:ml-6">
      ...
      <p class="text-xs text-gray-400 mt-1">Photo by Bill Nicholls. CC 2.0</p>
    </div>
    ...
    <section class="pb-3 text-xl" id="eating">
      ...
      <div class="pb-5">
        Several North Georgia breweries and wineries are within a short drive of the park. See the <a href="/chattanooga/guides/breweries-and-wineries">Chattanooga breweries and wineries guide</a> for taprooms and tasting rooms in the area.
      </div>
    </section>
    <div class="mt-12 mb-6 md:float-right md:w-2/5 md:ml-6">
      ...
      <p class="text-xs text-gray-400 mt-1">Photo by Jeff Gunn. CC 2.0</p>
    </div>
    <section class="pb-3 text-xl">
      ...
      <div>
        <div>
          ...
          <div class="mb-3">
            <span class="text-2xl"><b>Cave Tours</b></span>
            <span class="text-customGreen1 text-4xl font-bold">. </span> Want a real adventure? A park naturalist leads guided trips into Sitton's Cave, a wild cave with no lights or handrails. You scramble over rocks and crawl through mud, so wear old clothes and closed-toe shoes. Tours run in April, June, July, September, and October. Each one lasts about 2 to 2.5 hours and costs $45 per person, ages 10 and up. Call the park office at <a href="tel:7066574050">706-657-4050</a> to book ahead. Experienced cavers can also get a permit for Case Cave, which needs ropes and harnesses.
          </div>
          <div class="mb-3">
            <span class="text-2xl"><b>Bike Rentals</b></span>
            <span class="text-customGreen1 text-4xl font-bold">. </span> No bike? No problem. You can rent a mountain bike at the Visitor Center to ride the 5 Points trails. Rentals cost $35 for a half day and $55 for a full day. Call ahead to check availability before you drive out.
          </div>
          <div class="mb-3">
            <span class="text-2xl"><b>Accessibility</b></span>
            <span class="text-customGreen1 text-4xl font-bold">. </span> The park keeps an all-terrain Action Trackchair on hand, so visitors with mobility needs can reach rugged ground. The office also lends EnChroma glasses that help color-blind guests see the fall leaves and canyon views. Ask at the park office to reserve either one.
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            Waterfalls. If you read through this guide (thanks if you did, big fan of you) you will have seen multiple mentions of waterfalls in the park. There's Hemlock Falls and Cherokee Falls, both reached by the <a href="#advanced-hikes">Waterfalls Trail</a> off the West Rim loop. The water levels can vary significantly depending on rainfall but when they are flowing it's really a sight to behold.
          </div>
          <div class="mb-3">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <a href="/chattanooga/guides/outdoors" class="group block rounded-lg overflow-hidden border border-gray-200 hover:shadow-md transition-shadow">
          <div class="h-40 overflow-hidden">
            <OptimizedImage src="/images/chattanooga_guides/outdoors/cloudland/trail-shot.webp" alt="Outdoor Adventures" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" />
          </div>
          <div class="p-4">
            <div class="text-xl font-semibold gradient-text">Outdoor Adventures</div>
            <div class="text-sm text-gray-500 mt-1">Hiking, kayaking, climbing, and more</div>
          </div>
        </a>
